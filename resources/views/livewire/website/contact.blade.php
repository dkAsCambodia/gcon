<div>
    ...
    <section class="map py-0">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3877.203273287504!2d102.56600707573027!3d13.64539549974687!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x311b174af664d179%3A0x767a10d402b36706!2zQkVFUiBDSVRZIFBvaXBldCDguYLguIvguJkz!5e0!3m2!1sen!2skh!4v1728979431097!5m2!1sen!2skh" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <div class="map-container">
        <div class="contact-panel p-0">
          <div class="panel-header">
            <h3 class="panel-title color-white mb-0">Poipet Offices</h3>
          </div>
          <div class="accordion" id="accordion">
            <div class="accordion-item opened">
              <div class="accordion-header" data-toggle="collapse" data-target="#collapse1">
                <a class="accordion-title" href="#">AKIA Thmey Office</a>
            ...
            <div class="accordion-item">
              <div class="accordion-header" data-toggle="collapse" data-target="#collapse2">
                <a class="accordion-title" href="#">Kaipram Office</a>
              </div><!-- /.accordion-item-header -->
    ...
    <!-- ========================
      FancyBox Layout 3
    =========================== -->
    <section class="fancybox-layout3 bg-overlay bg-overlay-primary-gradient">
            ...
            <div class="d-flex">
              ...
              <div>&nbsp;
                <a href="#" class="color-secondary underlined-text-secondary font-weight-bold">97% Customer
                  Satisfaction</a>
                <span class="color-gray">based on 750+ reviews from our beloved customers and 20,000 popular
                  Entertainment!</span>
              </div>
            </div>
          </div><!-- /.col-lg-6 -->
