<ul class="list-unstyled mb-0" wire:ignore>
    ...
    <li>
      <a href="/dashboard/specialEvents" wire:navigate class="{{ Route::is('dashboard.specialEvents') ? 'active' : '' }}"><span class="cat-title">{{ __('message.My Events booking') }}</span><span class="cat-count"><i class="fa fa-list" aria-hidden="true"></i></span></a>
    </li>
    <li>
    ...
    <li>
      <a href="/dashboard/myOrderedFoods" wire:navigate class="{{ Route::is('dashboard.myOrderedFoods') ? 'active' : '' }}"><span class="cat-title">{{ __('message.My order') }}</span><span class="cat-count"><i class="fa fa-list" aria-hidden="true"></i></span></a>
    </li>
    {{-- <li>
